import sha512Wgsl          from '../shaders/primitives/sha512.wgsl?raw';
import pipelineSha512Wgsl  from '../shaders/pipeline_sha512.wgsl?raw';
import bigintWgsl          from '../shaders/primitives/bigint.wgsl?raw';
import ffWgsl              from '../shaders/primitives/ff.wgsl?raw';
import edWgsl              from '../shaders/primitives/edwards25519.wgsl?raw';
import pipelineScalarWgsl  from '../shaders/pipeline_scalar_mult.wgsl?raw';
